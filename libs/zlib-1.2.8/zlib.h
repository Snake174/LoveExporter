...
ZEXTERN int  inflateGetDictionary OF((z_streamp strm,
                                             Bytef *dictionary,
                                             uInt  *dictLength));
/*
...
/*
ZEXTERN int  inflateBackInit OF((z_streamp strm, int windowBits,
...
ZEXTERN uLong  compressBound OF((uLong sourceLen));
/*
...
ZEXTERN int  gzbuffer OF((gzFile file, unsigned size));
/*
...
ZEXTERN int  gzungetc OF((int c, gzFile file));
/*
...
/*
ZEXTERN z_off_t  gzoffset OF((gzFile file));
...
ZEXTERN int  gzdirect OF((gzFile file));
/*
...
ZEXTERN int  gzclose_r OF((gzFile file));
ZEXTERN int  gzclose_w OF((gzFile file));
/*
...
ZEXTERN void  gzclearerr OF((gzFile file));
/*
...
/*
ZEXTERN uLong  adler32_combine OF((uLong adler1, uLong adler2,
                                          z_off_t len2));
...
/*
ZEXTERN uLong  crc32_combine OF((uLong crc1, uLong crc2, z_off_t len2));
...
ZEXTERN int  inflateInit2_ OF((z_streamp strm, int  windowBits,
                                      const char *version, int stream_size));
ZEXTERN int  inflateBackInit_ OF((z_streamp strm, int windowBits,
                                         unsigned char FAR *window,
                                         const char *version,
                                         int stream_size));
...
ZEXTERN int  gzgetc_ OF((gzFile file));  /* backward compatibility */
#ifdef Z_PREFIX_SET
#  undef z_gzgetc
#  define z_gzgetc(g) \
...
#  ifndef Z_LARGE64
     ZEXTERN gzFile  gzopen64 OF((const char *, const char *));
     ZEXTERN z_off_t  gzseek64 OF((gzFile, z_off_t, int));
     ZEXTERN z_off_t  gztell64 OF((gzFile));
     ZEXTERN z_off_t  gzoffset64 OF((gzFile));
     ZEXTERN uLong  adler32_combine64 OF((uLong, uLong, z_off_t));
     ZEXTERN uLong  crc32_combine64 OF((uLong, uLong, z_off_t));
#  endif
#else
   ZEXTERN gzFile  gzopen OF((const char *, const char *));
   ZEXTERN z_off_t  gzseek OF((gzFile, z_off_t, int));
   ZEXTERN z_off_t  gztell OF((gzFile));
   ZEXTERN z_off_t  gzoffset OF((gzFile));
   ZEXTERN uLong  adler32_combine OF((uLong, uLong, z_off_t));
   ZEXTERN uLong  crc32_combine OF((uLong, uLong, z_off_t));
#endif
...
ZEXTERN const char   *  zError           OF((int));
ZEXTERN int             inflateSyncPoint OF((z_streamp));
ZEXTERN const z_crc_t FAR *  get_crc_table    OF((void));
ZEXTERN int             inflateUndermine OF((z_streamp, int));
ZEXTERN int             inflateResetKeep OF((z_streamp));
ZEXTERN int             deflateResetKeep OF((z_streamp));
#if defined(_WIN32) && !defined(Z_SOLO)
ZEXTERN gzFile          gzopen_w OF((const wchar_t *path,
                                            const char *mode));
#endif
